let words = [
    { polish: "przestraszony", english: "afraid", synonyms: ["fearful", "petrified"] },
    ...
    { polish: "szczupły", english: "slim", synonyms: ["slender", "lean"] },
    { polish: "powolny", english: "slow", synonyms: ["sluggish"] },
    { polish: "silny", english: "strong", synonyms: ["robust"] },
    { polish: "głupi", english: "stupid", synonyms: ["dump", "moronic"] },
    { polish: "smaczny", english: "tasty", synonyms: ["mouth-watering"] },
    { polish: "zmęczony", english: "tired", synonyms: ["wasted", "fatigued"] },
    { polish: "brzydki", english: "ugly", synonyms: ["hideous"] },
    { polish: "nieprzyjemny", english: "unpleasant", synonyms: ["gross", "obnoxious"] },
    { polish: "nieszczęśliwy", english: "unhappy", synonyms: ["miserable"] },
    { polish: "słaby, kruchy", english: "weak", synonyms: ["fragile", "frail"] },
    { polish: "mokry", english: "wet", synonyms: ["soaked"] },
    { polish: "chętny", english: "willing", synonyms: ["eager"] },
    { polish: "zmartwiony", english: "worried", synonyms: ["distressed", "anxious"] },
];
